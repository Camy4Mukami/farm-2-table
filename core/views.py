...
def payment(request):
    ...
    if request.method == "POST":
        ...
        if response.status_code == 200:
            # Payment request successful, redirect to home with success message
            return redirect('home')  # Replace 'home' with the actual URL or view name for your home page
        else:
            # Payment request failed, handle the failure (e.g., show an error message)
            return HttpResponse("Payment request failed. Please try again.")
